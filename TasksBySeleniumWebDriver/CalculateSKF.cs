...
namespace TasksBySeleniumWebDriver
{
    class CalculateSKF
    {
        ...
        public void test()
        {
            ...
            creatinin.SendKeys(Convert.ToString(creatininValue));

            var age = driver.FindElement(ageInputField);
            age.SendKeys(Convert.ToString(ageValue));

            var weight = driver.FindElement(weightInputField);
            weight.SendKeys(Convert.ToString(weightValue));

            var height = driver.FindElement(heightInputField);
            height.SendKeys(Convert.ToString(heightValue));
